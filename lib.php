...
function buttons_process_css($css, $theme) {
    ...
    $css = buttons_set_regionwidth($css, $regionwidth);
    ...
    $css = buttons_set_customcss($css, $customcss);
 ...
 * @return string
 */
function buttons_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function buttons_set_customcss($css, $customcss) {
